...
stairwell = Room.new("Stairwell", "The stairwell lights are eerily flickering on and off and was that a mouse that just ran across your foot?\n\nBut the end is in sight, caffeine awaits beyond this door!", question5, cafe)
...
makerspace = Room.new("Maker Space", "There's a VR headset discarded on the floor - no doubt another unsuspecting student has fallen victim to the high beam jump!\n\nWhat sort of devilry is afoot?", question2, kitchen)
classroom = Room.new("Classroom", "You have been working on your project for hours and are starting to get tired - time to get some caffeine.\n\nSuddenly the steady hum of computers is drowned out by a shriek in the adjoining room.\n\nPress \"LEAVE\' to investigate.", question1, makerspace)
